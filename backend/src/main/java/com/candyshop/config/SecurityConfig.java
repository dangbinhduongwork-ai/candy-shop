...
import com.candyshop.security.JwtAuthenticationFilter;
import com.candyshop.security.UserDetailsServiceImpl;
...
public class SecurityConfig {
    ...
    private final com.candyshop.security.RateLimitingFilter rateLimitingFilter;
    ...
    public SecurityConfig(UserDetailsServiceImpl userDetailsService,
                          ...
                          com.candyshop.security.RateLimitingFilter rateLimitingFilter) {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
            ...
            // Add RateLimitingFilter and JWT filter
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        // Hỗ trợ nhiều origins phân cách bởi dấu phẩy (dev + production Vercel)
